 ...
 */
final class Version20200509110122 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product ADD CONSTRAINT FK_D34A04AD508FCE6D FOREIGN KEY (new_fournisseur_id) REFERENCES fournisseur (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
