 ...
 */
final class Version20200526123952 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE gas_purchase ADD CONSTRAINT FK_2E5B47EC3423909 FOREIGN KEY (driver_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
